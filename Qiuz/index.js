...
const quiz = await inquirer.prompt([
    ...
    },
    {
        name: "question_2",
        type: "list",
        message: chalk.yellowBright.bold("Which of the following is NOT a valid TypeScript data type?"),
        choices: ["1. void", "2. any", "3. dynamic", "4. tuple"],
    },
    {
        name: "question_3",
        type: "list",
        message: chalk.yellowBright.bold("How do you denote a variable as readonly in TypeScript?"),
        choices: ["1. const", "2. static", "3. readonly", "4. fixed"],
    },
    {
        name: "question_4",
        type: "list",
        message: chalk.yellowBright.bold("How do you specify that a function does not return anything in TypeScript?"),
        choices: [
    ...
    },
    {
        name: "question_5",
        type: "list",
        message: chalk.yellowBright.bold("How do you define a custom type in TypeScript?"),
